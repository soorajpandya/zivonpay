-- ZivonPay Database Schema
-- PostgreSQL 16+
-- Production-Grade Payment Aggregator Schema
...
-- Insert default sandbox merchant for testing
...
--     'test@zivonpay.com',
--     '9999999999',
--     'zp_test_1234567890abcdef',
--     '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5GyYR.kkeHxJO', -- hashed 'test_secret'
--     'sandbox',
--     true,
--     true
-- );
...
-- Grant necessary permissions (adjust as per your user)
-- GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA public TO zivonpay;
-- GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA public TO zivonpay;
-- GRANT EXECUTE ON ALL FUNCTIONS IN SCHEMA public TO zivonpay;
